...
import loginAnimationData from "../../../../../public/Login.json";
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8 z-10">
        <div className="grid lg:grid-cols-2 gap-0 overflow-hidden bg-card/40 backdrop-blur-3xl border border-white/20 rounded-[40px] shadow-2xl shadow-primary/5 min-h-175">
          ...
          <div className="hidden lg:flex flex-col justify-between p-12 bg-primary/5 relative overflow-hidden border-r border-border/50">
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-10 -translate-y-2.5 animate-in fade-in slide-in-from-top-2 duration-700">
            ...
            <div className="relative h-100 w-full mt-auto flex items-center justify-center animate-in fade-in zoom-in-95 duration-1000 delay-500">
              <Lottie
