  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-background relative overflow-hidden">
      ...
      <div className="container max-w-6xl mx-auto px-4 py-8 z-10">
        <div className="grid lg:grid-cols-2 gap-0 overflow-hidden bg-card/40 backdrop-blur-3xl border border-white/20 rounded-[40px] shadow-2xl shadow-primary/5 min-h-162.5">
